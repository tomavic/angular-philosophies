...
### 1.1 Essentials (Recognize when the computer is smarter than you)
...
### 2.3 Architecting Enterprise Angular Application
...
### 3.1 Best practices for a clean and performant Angular application
